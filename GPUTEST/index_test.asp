...
<!-- #include virtual = "/a100/GPUTEST/topnav.html" -->
...
<body>
	...
	<div class="grid">
		...
		<div class="studyinfo">
			<p>A100 GPU 정보는 <a href="http://www.krinfra.co.kr/product/product_40.asp" target="_blank" rel="noopener noreferrer">한국인프라 A100 GPU 소개자료</a> 에서 확인할 수 있습니다.</p>
		</div>
		<div class="start">
			<button class="btn" align="center">시작하기</button>
		</div>
			<br>
		</div>
	</div>
